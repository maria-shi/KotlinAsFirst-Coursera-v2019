 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes*48 + arshins*16 + vershoks)*4.4445/100
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial*(100+percent)*(100+percent)*(100+percent)/1000000.00
...
fun numberRevert(number: Int): Int {
    val n1 = number/100 // 4
    val n2 = (number/10 - (number/100)*10) // 7
    val n3 = number-(number/100*100) - ((number/10 - (number/100)*10)*10) // 8
